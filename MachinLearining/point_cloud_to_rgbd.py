...
if __name__ == '__main__':
    ...
    depth = o3d.t.io.read_image("C:/Users/kawuli/Desktop/new_project3D/study_Point_cloudData/DemoCropPointCloud/TUM_depth.png").to(device)
    color = o3d.t.io.read_image("C:/Users/kawuli/Desktop/new_project3D/study_Point_cloudData/DemoCropPointCloud/TUM_color.png").to(device)
