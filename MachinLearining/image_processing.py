...
if __name__ == "__main__":
    ...
    sample_image = "C:/Users/kawuli/Desktop/new_project3D/study_Point_cloudData/DemoCropPointCloud/JuneauImage.jpg"
    x = o3d.io.read_image(sample_image)
    print(np.asarray(x))
    print(
        "Convert a numpy image to o3d.geometry.Image and show it with DrawGeomtries()."
    )
    y = mpimg.imread(sample_image)
    print(y.shape)
    ...
    im_raw = mpimg.imread(sample_image)
